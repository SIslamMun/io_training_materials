...
## Installation[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#installation "Direct link to Installation")
  * IoWarp
  * Spack
  * Pip
...
### Install Spack[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#install-spack "Direct link to Install Spack")
```
cd ${HOME}  
...
### Clone the IOWarp Spack Repo[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#clone-the-iowarp-spack-repo "Direct link to Clone the IOWarp Spack Repo")
```
cd ${HOME}  
...
### Install[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#install "Direct link to Install")
```
...
### Jarvis-Util[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#jarvis-util "Direct link to Jarvis-Util")
...
### Jarvis-CD[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#jarvis-cd-1 "Direct link to Jarvis-CD")
```
...
### Net Test[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#net-test "Direct link to Net Test")
...
## Building the Jarvis Configuration[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#building-the-jarvis-configuration "Direct link to Building the Jarvis Configuration")
...
### Bootstrapping for a single-node machine[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#bootstrapping-for-a-single-node-machine "Direct link to Bootstrapping for a single-node machine")
...
### Bootstrapping from a specific machine[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#bootstrapping-from-a-specific-machine "Direct link to Bootstrapping from a specific machine")
...
### Initialize jarvis configuration[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#initialize-jarvis-configuration "Direct link to Initialize jarvis configuration")
...
## Set or Change the active Hostfile[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#set-or-change-the-active-hostfile "Direct link to Set or Change the active Hostfile")
...
## Set Up Passwordless SSH[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#set-up-passwordless-ssh "Direct link to Set Up Passwordless SSH")
When working with more than one node, passwordless SSH is nice-to-have. While most HPC machines are already equipped with this, some types such as Chameleon Cloud, Cloudlab, and other bare-metal deployments do not. Jarvis comes with some tools to help bootstrap this. Here is an example for Chameleon.
...
Next, you have to copy that key to all nodes. First, construct a hostfile containing all nodes you have allocated
```
...
## Building a Resource Graph[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/index/#building-a-resource-graph "Direct link to Building a Resource Graph")
...
[Previous Hostfile](https://grc.iit.edu/docs/jarvis/jarvis-util/hostfile)[Next Pipelines](https://grc.iit.edu/docs/jarvis/jarvis-cd/pipelines)
