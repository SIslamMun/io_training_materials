...
On this page
# WRF
## Installation[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#installation "Direct link to Installation")
### System Check[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#system-check "Direct link to System Check")
...
### Create a library folder and install the library[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#create-a-library-folder-and-install-the-library "Direct link to Create a library folder and install the library")
```
mkdir Build_WRF  
cd Build_WRF  
mkdir LIBRARIES  
...
### Choice 1: Install the library(with the HDF5 support and without PnetCDF support)[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#choice-1-install-the-librarywith-the-hdf5-support-and-without-pnetcdf-support "Direct link to Choice 1: Install the library\(with the HDF5 support and without PnetCDF support\)")
...
### Choice 2: Install the libarary(with both HDF5 support and PnetCDF support)[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#choice-2-install-the-libararywith-both-hdf5-support-and-pnetcdf-support "Direct link to Choice 2: Install the libarary\(with both HDF5 support and PnetCDF support\)")
TBD, Looks like not necessary for this case
### Install WPS[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#install-wps "Direct link to Install WPS")
...
## Usage[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#usage "Direct link to Usage")
  1. Download the benchmark dataset, here is the website for dataset: <https://www2.mmm.ucar.edu/wrf/users/benchmark/v44/benchdata_v44.html> Choose one of them for testing. Unzip the file. copy the wrfbdy_d01, wrfinput_d01 and namelist.input file to WRF/test/em_real file.
...
Run wrf with adios2 add adios2.xml file in the same folder(wrf/test/em_real) Here is the example of adios2.xml file:
```
<?xml version="1.0"?>  
<adios-config>  
...
## Post Processing[​](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/wrf/#post-processing "Direct link to Post Processing")
...
[Previous VPIC](https://grc.iit.edu/docs/jarvis/jarvis-cd/packages/vpic)[Next Future Work](https://grc.iit.edu/docs/jarvis/jarvis-cd/future-work)
