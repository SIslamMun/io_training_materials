...
- **Language:** Julia
- **License:** MIT License
- **Source:** `https://github.com/eschnett/ADIOS2.jl`
- **Branch:** `main`
- **Commit:** `12b0cbbf1437`
- **Last Commit:** 2026-01-22 11:20:16 -0500
- **Commits:** 1
- **Extracted:** 2026-01-23T02:45:11.480934
...
- `.gitignore` (74 bytes)
- `LICENSE.md` (1,076 bytes)
- `docs/.gitignore` (13 bytes)
- `.JuliaFormatter.toml` (234 bytes)
- `.github/workflows/CI.yml` (2,152 bytes)
- `.github/workflows/CompatHelper.yml` (933 bytes)
- `.github/workflows/CompatLowerBounds.yml` (2,692 bytes)
- `.github/workflows/TagBot.yml` (648 bytes)
- `.github/workflows/docs.yml` (1,214 bytes)
- `Project.toml` (347 bytes)
- `docs/Project.toml` (59 bytes)
- `docs/src/index.md` (2,850 bytes)
- `test/Project.toml` (193 bytes)
